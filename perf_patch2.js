...
r("    function drawBullets(){\n      bullets.forEach(function(b){\n        ctx.fillStyle='#8ae2ff';\n        ctx.fillRect(b.x,b.y,b.w,b.h);\n        ctx.fillStyle='rgba(138,226,255,0.3)';\n        ctx.fillRect(b.x-1,b.y+b.h,b.w+2,8);\n      });\n    }",
  "    function drawBullets(){if(!bullets.length)return;for(var bi=0,bl=bullets.length;bi<bl;bi++){var b=bullets[bi];ctx.fillStyle='#8ae2ff';ctx.fillRect(b.x,b.y,b.w,b.h);ctx.fillStyle='rgba(138,226,255,0.3)';ctx.fillRect(b.x-1,b.y+b.h,b.w+2,8);}}");
...
// 9. drawEnemies (may already be replaced)
...
// 11. drawPlayer shield arc (may already be replaced)
...
// 12. Ensure any remaining Math.PI*2 is replaced
